...
const Education = () => {
    return (
        <div>
            <div id="education" className="container mx-auto bg-black my-10">
                        ...
                        <div className="relative rounded-2xl px-6 py-10 bg-gray-700 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                            ...
                            <div className="relative flex flex-col">
                                <div className="sm:text-center">
                                    <h2 className="text-3xl font-bold leading-tight text-gray-200 dark:text-white sm:text-4xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-tr to-cyan-500 from-blue-600">Education</h2>
                                    <p className="mt-6 mx-auto max-w-2xl text-lg text-gray-100"> I recently graduated from First Capital University of Bangladesh
                                        in Public Health (BPH) </p>
                                </div>
                                {/* <a href="#"
