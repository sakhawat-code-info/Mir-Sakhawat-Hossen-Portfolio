...
const MyProjects = () => {
    return (
        <div id="myProjects" className="container mx-auto p-5 sm:p-10 md:p-16 bg-gray-900 text-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 pb-20">
                ...
                <div className="rounded overflow-hidden shadow-lg flex flex-col ">
                    ...
                    <div className="px-6 py-4 mb-auto">
                        ...
                        <div className="grid grid-cols-2 gap-3 my-2">
                            ...
                            <p className="bg-gray-600 px-3 py-1 rounded">Tailwind CSS</p>
                    ...
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        <span href="#" className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                            ...
                            <span className="ml-1">4 days</span>
                        </span>
                ...
                <div className="rounded overflow-hidden shadow-lg flex flex-col ">
                    ...
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        <span href="#" className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                            ...
                            <span className="ml-1">6 days</span>
                        </span>
                ...
                <div className="rounded overflow-hidden shadow-lg flex flex-col ">
                    ...
                    <div className="relative"><a href="#">
                        ...
                        <a href="https://b9a12-client-side.web.app/" target="_blank">
                            <div
                                className="text-xs absolute top-0 right-0 bg-indigo-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                                Live
                            </div>
                    ...
                    <div className="px-6 py-4 mb-auto">
                        <a href="#"
                            className="font-medium text-lg  hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Diagnostic Center Management System [Full Stack]</a>
                        <p className="text-gray-500 text-sm text-left">
                            A full-stack web application that effectively manages appointments, patient records, test
                            results, and administrative tasks for a diagnostic center <br />
                            Simplify billing and payment processes with our integrated system. Manage invoices, process payments, and handle insurance claims with ease. <br />
                            Users can read reviews and ratings from other consumers to make informed decisions.
                        </p>
                        <div className="grid grid-cols-2 gap-3 my-2">
                            <p className="bg-gray-600 px-3 py-1 rounded">React.js</p>
                    ...
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        ...
                        <a className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                            <IoLogoGithub size={15} />
                            <a href="https://github.com/sakhawat-code-info/Revival-Diagnostic-Center-Project-3" target="_blank" className="ml-1 text-red-800 font-extrabold">Clint</a>

                            <a href="https://github.com/programming-hero-web-course1/b9a12-server-side-sakhawat-code-info" target="_blank" className="ml-1 text-green-800 font-extrabold">Server</a>
                        </a>
                    </div>
                </div>
